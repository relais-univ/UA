// ==========================================
// CONFIGURATION DE L'ESPACE ZEN & LECTEUR INTERACTIF
// ==========================================
...
let trackEnCoursId = null; // Stocke l'ID unique de la chanson qui joue
...
// Génère les en-têtes de rubriques et les répertoires cachés (dépliants)
function genererCategoriesInterface() {
    ...
    categoriesMusique.forEach(cat => {
        ...
        // Div cachée qui contient le répertoire des 20 chansons
        ...
        // Injection des 20 morceaux dans le répertoire courant
...
// Fonction d'ouverture et fermeture fluide façon répertoire de musique
function toggleRepertoireAffichage(catId) {
    ...
    // On ferme d'abord tous les autres répertoires ouverts pour faire propre
...
// Déclenche précisément le morceau sur lequel l'étudiant a cliqué
